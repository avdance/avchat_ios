...
class ACViewController: UIViewController ,UITextFieldDelegate,NVActivityIndicatorViewable {
//    let window = UIApplication.shared.keyWindow!
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        view.backgroundColor = DynamicColor(hex: 0xF6F6F6)
        
        setStatusBarBackgroundColor(color: DynamicColor(hex: 0x00bc70))
